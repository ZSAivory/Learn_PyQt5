...
class App(QWidget):
    ...
    def createTable(self):
        ...
        self.tableWidget.setItem(1, 0, QTableWidgetItem("Cell (1,2)"))
        self.tableWidget.setItem(2, 0, QTableWidgetItem("Cell (2,1)"))
        self.tableWidget.setItem(3, 0, QTableWidgetItem("Cell (2,2)"))
        self.tableWidget.setItem(4, 0, QTableWidgetItem("Cell (3,1)"))
